...
class StudentEidRequestScreen extends StatefulWidget {
  const StudentEidRequestScreen({super.key});

  @override
  State<StudentEidRequestScreen> createState() =>
      _StudentEidRequestScreenState();
}

class _StudentEidRequestScreenState extends State<StudentEidRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading =
        updateProvider.stateFor('student_eid') == AppStates.Initial_Fetching;
    ...
    return Scaffold(
      ...
      appBar: const CommonAppBar(title: 'Request Emirates ID Update'),
      body: Column(
  ...
  Future<void> _onSubmit() async {
    ...
    final success = await updateProvider.submitStudentEidRequest(
