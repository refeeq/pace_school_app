...
import 'package:school_app/views/components/calender/platform_widgets.dart';
...
typedef EventListBuilder =
    Function(BuildContext context, List<NeatCleanCalendarEvent> events);
...
class CalendarState extends State<Calendar> {
  ...
  List<DateTime> _daysInMonth(DateTime month) {
    ...
    var lastToDisplay = last.add(
      Duration(days: daysAfter + (widget.startOnMonday ? 1 : 0)),
    );
