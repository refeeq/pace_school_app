...
class SelectStudentWidget extends StatelessWidget {
  ...
  /// When true, the bar is styled for placement on [ConstColors.primary] (e.g. Communication app bar): light text and ring avatars on blue.
      ...
      builder: (context, studentProvider, communicationProvider, child) {
        switch (studentProvider.studentListState) {
          ...
          case AppStates.Fetched:
            return Container(
              decoration: onPrimaryBackground
                  ? BoxDecoration(
                  ...
                  itemBuilder: (context, index) => GestureDetector(
                    onTap: () {
                      ...
                      Provider.of<StudentProvider>(
                        context,
                        listen: false,
                      ).selectStudent(selected, index: index);
                      onchanged(index);
                    },
                    child: Padding(
                            ...
                            Builder(
                              builder: (context) {
                                ...
                                return Stack(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      backgroundColor: onPrimaryBackground
                                          ? (isSelected
                                                ? Colors.white
